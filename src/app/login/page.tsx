    ...
    <div className="min-h-screen bg-[#0b0f1a] px-3 pt-14 pb-8">
      <div className="max-w-sm mx-auto">
        <div className="text-center mb-5">
          ...
          <p className="text-[9px] text-[#64748b] mt-0.5">EkromNetVPN</p>
        </div>
        <div className="bg-[#111927] border border-[#1e2d47] rounded-lg p-3">
          <form onSubmit={e => e.preventDefault()}>
            ...
            <div className="relative mb-3">
              ...
              <button type="button" onClick={() => setShow(!show)} className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[9px] text-[#64748b]">{show ? "🙈" : "👁️"}</button>
            </div>
            <button className="w-full py-2 rounded-lg bg-[#00e68a] text-black font-bold text-[10px]">เข้าสู่ระบบ</button>
          </form>
