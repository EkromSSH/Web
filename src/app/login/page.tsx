    ...
    <div className="min-h-screen bg-[#0b0f1a] pt-16 px-4">
      <div className="max-w-sm mx-auto">
        ...
        <div className="bg-[#111927] border border-[#1e2d47] rounded-xl p-4">
          <h2 className="text-sm font-bold mb-4">🔑 เข้าสู่ระบบ</h2>
          <form onSubmit={e => e.preventDefault()}>
            ...
            <div className="relative mb-4">
              <input type={show ? "text" : "password"} className="w-full p-3 bg-[#0b0f1a] border border-[#1e2d47] rounded-lg text-sm text-white pr-10 focus:border-[#00e68a] outline-none" placeholder="รหัสผ่าน" required />
            ...
            <button type="submit" className="w-full py-3 rounded-lg bg-[#00e68a] text-black font-bold text-sm">เข้าสู่ระบบ</button>
          </form>
          <div className="mt-3 text-center text-xs text-[#64748b]">ยังไม่มีบัญชี? <Link href="/register" className="text-[#00e68a]">สมัคร</Link></div>
        </div>
      </div>
    </div>
  );
